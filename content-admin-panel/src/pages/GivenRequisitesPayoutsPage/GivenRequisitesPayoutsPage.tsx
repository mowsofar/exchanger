...
import { useGivenRequisitesPayoutsPage } from './GivenRequisitesPayoutsPage.hooks';
import {
    PayoutsList,
    SpinnerWrapper,
    StyledButton,
    ...
    StyledHeader,
    StyledRoot,
} from './GivenRequisitesPayoutsPage.styled';
...
export const GivenRequisitesPayoutPage: React.FC = () => {
    ...
    return (
        <>
            <head>
                <title>Ревизиты выданы</title>
            </head>

            <StyledRoot>
                <StyledHeader>
                    <Headline3>Реквизиты выданы</Headline3>
