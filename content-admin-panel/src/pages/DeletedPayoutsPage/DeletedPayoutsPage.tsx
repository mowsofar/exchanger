...
import { useDeletedPayoutsPage } from './DeletedPayoutsPage.hooks';
import {
    PayoutsList,
    SpinnerWrapper,
    StyledButton,
    ...
    StyledHeader,
    StyledRoot,
} from './DeletedPayoutsPage.styled';
...
export const DeletedPayoutsPage: React.FC = () => {
    const { page, handleClickPage, isLoading, editPayoutStatus, setPayoutRequisites } = useDeletedPayoutsPage();
    ...
    return (
        <>
            <head>
                <title>Отклонённые заявки</title>
            </head>

            <StyledRoot>
                <StyledHeader>
                    <Headline3>Отклонённые заявки</Headline3>
